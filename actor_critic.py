...
class ActorCritic(nn.Module):
    def __init__(self, act_vocab_size=7) -> None:
        super().__init__()
...
def batch_rollout(actor0, actor1, envs) -> RolloutOutput:
...
if __name__ == '__main__':
    ...
    for epoch in tqdm(range(n_epoch)):
        ...
        rewards_all.append(rewards0 + rewards1)
